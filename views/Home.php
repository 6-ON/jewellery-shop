          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    <img src="images/slider-img.png" alt="golden ring">
                  </div>
                </div>
              </div>
            </div>
            <div class="carousel-item ">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    <img src="images/pngegg.png" style="scale: 0.8;" alt="">
                  </div>
                </div>
              </div>
            </div>
            <div class="carousel-item ">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    <img src="images/slider-img.png" alt="Ring">
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="container">
      <div class="item_container">
        <div class="box">
          ...
          <div class="img-box">
            <img src="images/i-1.png" alt="golden ring">
          </div>
          <div class="name">
            <h5>
              Bracelet
